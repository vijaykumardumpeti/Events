...
export default class Events extends Component {
  ...
  onclickEvent = (registrationStatus, id) => {
    ...
    if (registrationStatus === statusesObject.registrationsClosed) {
      this.setState({
        status: statusesObject.registrationsClosed,
      })
    }
    if (registrationStatus === statusesObject.registered) {
      this.setState({
        status: statusesObject.registered,
      })
    }
  }
  ...
  render() {
    ...
    return (
      <div className="events-bg-container">
        ...
        <div className="activeEvent-details-container">
